...
export const TOOL_REGISTRY = {
  ...
  "date-difference-calculator": {
    ...
    metaDescription: "Free online date difference calculator. Calculate the number of calendar days, working business days, and weekends between two dates.",
  ...
  "bmi-calculator": {
    ...
    metaDescription: "Free online BMI calculator. Calculate your Body Mass Index (BMI), ideal weight range, and WHO health categories in seconds.",
  ...
  "byte-converter": {
    ...
    metaDescription: "Free online byte converter. Transform file sizes and storage units between B, KB, MB, GB, TB, and PB using 1024 (binary) or 1000 (decimal) bases.",
