...
export const PHASE2_TOOLS: Record<string, ToolConfig> = {
  "salary-calculator": {
    ...
    category: "financial",
    title: "Salary Take-Home Pay Calculator - Net In-Hand Income",
    subtitle: "Calculate monthly take-home in-hand salary from gross CTC after deducting provident fund (PF), professional tax, and income taxes.",
    metaDescription: "Free online salary calculator. Calculate your net take-home in-hand pay from annual gross CTC with breakdown of PF, taxes, and allowances.",
    ...
    featured: true,
    keywords: ["salary calculator", "take home pay calculator", "in hand salary", "ctc to in hand", "net salary calculator", "paycheck calculator"],
  ...
  "income-tax-calculator": {
    ...
    category: "financial",
    title: "Income Tax Calculator - Slab Rates & Tax Liability",
    subtitle: "Estimate your income tax liability across progressive tax slabs with standard deduction and cess calculations.",
    metaDescription: "Free online income tax calculator. Estimate progressive income tax liability across brackets with standard deduction and cess breakdowns.",
    ...
    badge: "Tax Ready",
    featured: true,
    keywords: ["income tax calculator", "tax slab calculator", "tax liability estimator", "calculate income tax online", "tax deduction calculator"],
