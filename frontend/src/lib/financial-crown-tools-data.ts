...
export const FINANCIAL_CROWN_TOOLS: Record<string, ToolConfig> = {
  "mortgage-calculator": {
    ...
    category: "financial",
    title: "Mortgage Calculator (2026) – Amortization Schedule & PITI Payment Breakdown",
    ...
    metaDescription: "Free online mortgage calculator (2026). Calculate monthly PITI payments, compare 15-yr vs 30-yr fixed rates, model extra principal payoff savings, and export amortization schedules to Excel (.xlsx).",
  ...
  "inflation-calculator": {
    ...
    category: "financial",
    title: "Inflation Calculator (2026) – What Will Cash Be Worth & Purchasing Power Loss",
    ...
    metaDescription: "Free online inflation and purchasing power calculator (2026). Calculate future equivalent living costs, cumulative inflation percentages, and purchasing power erosion curves with Excel export.",
